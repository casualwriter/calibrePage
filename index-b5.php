...
<div id=header class="w3-bar">
  ...
  <span class="w3-right">
    <form>
      <input name=key size=12 placeholder='書名/作者/出版社' value="<?=$keyword?>"/> 
...
<div id=content> 
  ...
  echo "<div class='w3-container'><p><b>[標籤]</b> ";
  foreach ($result as $row) { 
...
function showBook(id) {
  ...
  for (i=0; i<tags.length; i++) html+=(i==0?'<br>標籤: ':' | ')+'<a href="<?=$thisPrg?>?tag='+tags[i]+'">'+tags[i]+'</a>'
